...
data "azurerm_virtual_network" "fgtvnetwork" {
  name                = var.vnet_name
...
resource "azurerm_subnet" "publicsubnet" {
  name                 = "publicSubnet"
  resource_group_name  = var.vnet_resourcegroup_name
  virtual_network_name = data.azurerm_virtual_network.fgtvnetwork.name
...
resource "azurerm_network_interface" "activeport1" {
  ...
  ip_configuration {
    ...
    private_ip_address            = local.activeport1
    primary                       = true
...
resource "azurerm_network_interface" "activeport2" {
  ...
  ip_configuration {
    ...
    private_ip_address_allocation = "Static"
    private_ip_address            = local.activeport2
...
resource "azurerm_network_interface" "activeport3" {
  ...
  ip_configuration {
    ...
    private_ip_address_allocation = "Static"
    private_ip_address            = local.activeport3
  }
...
resource "azurerm_network_interface" "passiveport1" {
  ...
  ip_configuration {
    ...
    subnet_id                     = azurerm_subnet.hamgmtsubnet.id
    private_ip_address_allocation = "Static"
    private_ip_address            = local.passiveport1
    primary                       = true
...
resource "azurerm_network_interface" "passiveport2" {
  ...
  ip_configuration {
    ...
    subnet_id                     = azurerm_subnet.publicsubnet.id
    private_ip_address_allocation = "Static"
    private_ip_address            = local.passiveport2
  }
...
resource "azurerm_network_interface" "passiveport3" {
  ...
  ip_configuration {
    ...
    subnet_id                     = azurerm_subnet.privatesubnet.id
    private_ip_address_allocation = "Static"
    private_ip_address            = local.passiveport3
  }
